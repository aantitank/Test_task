...
abstract class Article implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Model\\Map\\ArticleTableMap';
     ...
     *
     * Note: this column has a database default value of: 'Default title'
     * @var        string
     */
    protected $title;
    ...
    /**
     * Initializes internal state of AppBundle\Model\Base\Article object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\AppBundle\Model\Article The current object (for fluent API support)
     */
    ...
    public function setAbstract($v)
    {
        ...
        if ($this->abstract !== $v) {
            $this->abstract = $v;
            $this->modifiedColumns[ArticleTableMap::COL_ABSTRACT] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ArticleTableMap::COL_DATE] = true;
            }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[ArticleTableMap::COL_TEXT] = true;
        }
    ...
    /**
     * Sets the value of the [activity] column.
    ...
    public function setActivity($v)
    {
        ...
        if ($this->activity !== $v) {
            $this->activity = $v;
            $this->modifiedColumns[ArticleTableMap::COL_ACTIVITY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArticleTableMap::translateFieldName('Abstract', TableMap::TYPE_PHPNAME, $indexType)];
            $this->abstract = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArticleTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArticleTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArticleTableMap::translateFieldName('Activity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activity = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Model\\Article'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_ABSTRACT)) {
            $modifiedColumns[':p' . $index++]  = 'abstract';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'text';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_ACTIVITY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'text':
                        ...
                        break;
                    case 'activity':
                        $stmt->bindValue($identifier, (int) $this->activity, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Model\Article
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Model\Article The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_ABSTRACT)) {
            $criteria->add(ArticleTableMap::COL_ABSTRACT, $this->abstract);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_DATE)) {
            $criteria->add(ArticleTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_TEXT)) {
            $criteria->add(ArticleTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_ACTIVITY)) {
            $criteria->add(ArticleTableMap::COL_ACTIVITY, $this->activity);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Model\Article (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Model\Article Clone of current object.
     * @throws PropelException
     */
